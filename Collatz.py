...
def collatz_eval_use_cache(i, j):
    ...
    if cache[lower_num_with_max_cyc_len_index] >= lower_range:
        ...
        max_cyc_len_lower = collatz_eval(lower_range,(lower_range//1000 * 1000 + 1000))
